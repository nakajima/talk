...
pub struct NameResolver {
    ...
    pub(super) current_module_id: crate::front::module::ModuleId,
...
impl NameResolver {
    ...
    fn precompiled_module_for(&self, resolved: &Path) -> Option<&crate::front::module::Module> {
        let name = self
            .precompiled_sources
    ...
    fn module_export_symbols(
        module: &crate::front::module::Module,
...
fn is_core_source_path(path: &str) -> bool {
    ...
    crate::front::module::CORE_SOURCE_NAMES.contains(&name)
}
