...
pub mod tests {
    ...
    use crate::any_decl;
    use crate::any_expr_stmt;
    use crate::any_stmt;
    use crate::parser_tests::tests::parse;
    use talk_front::ast::AST;
    use talk_front::ast::NameResolved;
    use talk_front::front::module::ModuleEnvironment;
    use talk_front::front::module::ModuleId;
    use talk_front::diagnostic::AnyDiagnostic;
    use talk_front::diagnostic::Diagnostic;
    use talk_front::diagnostic::Severity;
    use talk_front::hygiene::MaterializedIdentifier;
    use talk_front::hygiene::SyntaxContext;
    use talk_front::hygiene::SyntaxMetadata;
    use talk_front::hygiene::SyntaxOrigin;
    use talk_front::hygiene::SyntaxScope;
    use talk_front::label::Label;
    use talk_front::name::Name;
    use talk_front::name_resolution::name_resolver::NameResolver;
    use talk_front::name_resolution::name_resolver::NameResolverError;
    use talk_front::name_resolution::name_resolver::ResolvedNames;
    use talk_front::name_resolution::symbol::AssociatedTypeId;
    use talk_front::name_resolution::symbol::BuiltinId;
    use talk_front::name_resolution::symbol::DeclaredLocalId;
    use talk_front::name_resolution::symbol::EffectId;
    use talk_front::name_resolution::symbol::EnumId;
    use talk_front::name_resolution::symbol::GlobalId;
    use talk_front::name_resolution::symbol::InitializerId;
    use talk_front::name_resolution::symbol::InstanceMethodId;
    use talk_front::name_resolution::symbol::MethodRequirementId;
    use talk_front::name_resolution::symbol::ParamLocalId;
    use talk_front::name_resolution::symbol::PatternBindLocalId;
    use talk_front::name_resolution::symbol::PropertyId;
    use talk_front::name_resolution::symbol::ProtocolId;
    use talk_front::name_resolution::symbol::StaticMethodId;
    use talk_front::name_resolution::symbol::StructId;
    use talk_front::name_resolution::symbol::Symbol;
    use talk_front::name_resolution::symbol::SynthesizedId;
    use talk_front::name_resolution::symbol::TypeAliasId;
    use talk_front::name_resolution::symbol::TypeParameterId;
    use talk_front::name_resolution::symbol::VariantId;
    use talk_front::node_id::FileID;
    use talk_front::node_id::NodeID;
    use talk_front::node_kinds::type_application::TypeApplication;
    use talk_front::node_kinds::block::Block;
    ...
    use talk_front::node_kinds::expr::Expr;
    use talk_front::node_kinds::expr::ExprKind;
    use talk_front::node_kinds::func::CaptureMode;
    use talk_front::node_kinds::func::EffectSet;
    use talk_front::node_kinds::func::Func;
    use talk_front::node_kinds::func::FuncOrigin;
    use talk_front::node_kinds::func_signature::FuncSignature;
    use talk_front::node_kinds::generic_decl::GenericDecl;
    use talk_front::node_kinds::match_arm::MatchArm;
    use talk_front::node_kinds::parameter::ParamLabel;
    ...
    use talk_front::node_kinds::stmt::Stmt;
    use talk_front::node_kinds::stmt::StmtKind;
    use talk_front::node_kinds::type_annotation::TypeAnnotation;
    ...
    macro_rules! any_pattern {
        ($kind: expr) => {
            talk_front::parsing::node_kinds::pattern::Pattern {
                id: NodeID::ANY,
                span: Span::ANY,
                kind: $kind,
            }
    ...
    fn resolve_err(code: &'static str) -> (AST<NameResolved>, ResolvedNames) {
        ...
        talk_front::desugar::desugar(&mut parseds);
    ...
    fn hygienic_bindings_do_not_capture_use_site_references() {
        ...
        let outer = match &asts[0].roots[0] {
            talk_front::node::Node::Decl(Decl {
    ...
    fn resolves_simple_variable() {
        ...
        assert!(matches!(
            node,
            talk_front::node::Node::Pattern(talk_front::node_kinds::pattern::Pattern {
                kind: talk_front::node_kinds::pattern::PatternKind::Bind(_),
                ..
            })
        ));
    }
                ...
                type_annotation: Some(annotation!(TypeAnnotationKind::Nominal {
                    name: Name::Resolved(
                        Symbol::Builtin(BuiltinId::new(
                            talk_front::front::module::ModuleId::Core,
                            1
                        )),
                        "Int".into()
                    ),
    ...
    fn resolves_static_generic_argument_reference() {
        ...
        assert!(matches!(
            &generics[0],
            talk_front::node_kinds::generic_arg::GenericArg::Type(TypeAnnotation {
    ...
    fn resolve_multi(files: &[(&str, &str)]) -> (Vec<AST<NameResolved>>, ResolvedNames) {
        ...
        for (i, (path, code)) in files.iter().enumerate() {
            let (ast, _) =
                talk::compiling::frontend::parse_ast(code, FileID(i as u32), path).unwrap();
            parseds.push(ast);
        }
    ...
    fn resolves_named_import() {
        ...
        if let talk_front::node::Node::Stmt(Stmt {
            kind:
                StmtKind::Expr(Expr {
    ...
    fn declaration_records_carry_file_owner_role_and_visibility() {
        use talk_front::name_resolution::symbol::SymbolKind;
        use talk_front::node_kinds::decl::Visibility;
