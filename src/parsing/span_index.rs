...
pub struct SpanIndex {
    ...
    by_file_and_line: HashMap<PathBuf, HashMap<u32, Vec<(NodeID, Span)>>>,
}
...
impl SpanIndex {
    ...
    pub fn insert(&mut self, expr_id: NodeID, span: Span) {
    ...
    pub fn build_from(spans: &HashMap<NodeID, Span>) -> Self {
    ...
    pub fn find_at_position(&self, position: &Position, path: &PathBuf) -> Option<NodeID> {
        ...
        let mut candidates: Vec<&(NodeID, Span)> = line_spans
            .iter()
