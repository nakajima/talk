    ...
    pub fn to_typed(&self, typed_ids: &BTreeMap<ExprID, Ty>) -> TypedExprResult {
        match &self.expr {
            ...
            Expr::LiteralArray(parsed_exprs) => {
                ...
                TypedExprResult::Ok(crate::types::typed_expr::TypedExpr {
                    id: self.id,
                    expr,
            ...
            Expr::Unary(token_kind, parsed_expr) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Binary(lhs, token_kind, rhs) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Tuple(parsed_exprs) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
                expr: crate::types::typed_expr::Expr::Tuple(map!(parsed_exprs, typed_ids)),
                ty: lookup!(self.id, typed_ids),
            }),
            Expr::Block(parsed_exprs) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Return(parsed_expr) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Break => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::FuncTypeRepr(parsed_exprs, parsed_expr, introduces_type) => {
                TypedExprResult::Ok(TypedExpr {
                    id: self.id,
            ...
            Expr::TupleTypeRepr(parsed_exprs, introduces_type) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Member(parsed_expr, name) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Parameter(name, parsed_expr) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Let(name, parsed_expr) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Assignment(parsed_expr, parsed_expr1) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Variable(name) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
                expr: crate::types::typed_expr::Expr::Variable(resolve!(name)),
                ty: lookup!(self.id, typed_ids),
            }),
            Expr::If(cond, conseq, alt) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Loop(cond, body) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::EnumVariant(name, fields) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::Match(expr, arms) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::MatchArm(pattern, body) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::PatternVariant(enum_name, variant_name, values) => {
                TypedExprResult::Ok(TypedExpr {
                    id: self.id,
            ...
            Expr::RecordLiteral(fields) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
                expr: crate::types::typed_expr::Expr::RecordLiteral(map!(fields, typed_ids)),
                ty: lookup!(self.id, typed_ids),
            }),
            Expr::RecordField { label, value } => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::RecordTypeField { label, ty } => TypedExprResult::Ok(TypedExpr {
                id: self.id,
            ...
            Expr::RowVariable(name) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
                expr: crate::types::typed_expr::Expr::RowVariable(name.name_str().to_string()),
                ty: lookup!(self.id, typed_ids),
            }),
            Expr::Spread(expr) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
                expr: crate::types::typed_expr::Expr::Spread(Box::new(expr.to_typed(typed_ids)?)),
                ty: lookup!(self.id, typed_ids),
            }),
            Expr::ProtocolDecl {
                name,
            ...
            Expr::Import(path) => TypedExprResult::Ok(TypedExpr {
                id: self.id,
