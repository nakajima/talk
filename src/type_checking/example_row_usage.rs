...
mod examples {
    ...
    fn example_struct_with_rows() {
        ...
        let resolved = solution.substitutions.apply(&Ty::TypeVar(x_result), 0, &mut env.context);
    ...
    fn example_building_type_with_rows() {
        ...
        rect_def.add_methods_with_rows(vec![
            Method::new(
                "area".to_string(),
                ExprID(14),
        ...
        let resolved_area = solution.substitutions.apply(&Ty::TypeVar(area_result), 0, &mut env.context);
