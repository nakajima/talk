...
impl ConstantFolder {
    ...
    fn fold_function(func: &mut IRFunction) {
        ...
        let mut global_consts: HashMap<Register, ConstValue> = HashMap::new();
            ...
            for instr in std::mem::take(&mut block.instructions) {
                ...
                match instr {
                    ...
                    Instr::Phi(dest, ref ty, mut preds) => {
                        ...
                        if let Some(val) = Self::fold_phi(&preds, &global_consts) {
